...
const Button = ({
  ...
  const variants = {
    ...
    outline:
      "border-2 border-purple-500/50 hover:border-purple-500 text-purple-400 hover:text-purple-300",
  };
...
const SectionTitle = ({
  ...
  <div className={`mb-16 ${align === "center" ? "text-center" : "text-left"}`}>
    {subtitle && (
      <span className="text-purple-400 font-semibold tracking-widest uppercase text-sm mb-4 block">
        {subtitle}
      </span>
    )}
    <h2 className="text-3xl md:text-5xl font-bold text-white tracking-tight font-serif italic">
      {children}
    </h2>
  </div>
);
...
const FAQItem = ({
  ...
  return (
    <div className="border-b border-white/5">
      ...
      >
        <span className="text-lg font-semibold text-slate-200 group-hover:text-purple-400 transition-colors">
          {question}
        </span>
        <ChevronDown
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] font-sans text-slate-200 selection:bg-purple-500/30 selection:text-purple-200 bg-gradient-premium">
      {/* Navigation */}
      <nav
        className={`fixed top-0 w-full z-50 transition-all duration-300 ${isScrolled ? "bg-black/80 backdrop-blur-xl border-b border-white/5 py-3" : "bg-transparent py-6"}`}
      >
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <span className="text-2xl font-bold tracking-tighter text-white font-serif italic">
              Regentify
            </span>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-bold text-white leading-[1.1] mb-8 tracking-tight font-serif italic">
              Sua regência, elevada ao{" "}
              <span className="text-gradient">próximo nível</span>.
            </h1>
            <p className="text-xl text-slate-400 mb-10 leading-relaxed max-w-xl">
              O primeiro assistente digital feito exclusivamente para Regentes
              de Coral e Líderes de Louvor. Organize repertórios, gere PDFs
            ...
            <div className="mt-12 flex items-center gap-6"></div>
          </motion.div>
      ...
      <section id="solucao" className="py-24 relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div>
              <SectionTitle align="left" subtitle="O Problema">
                Você ainda sofre com a desorganização?
              </SectionTitle>
              <p className="text-xl text-slate-400 mb-12 leading-relaxed">
                Reger um coral já é um desafio artístico imenso. Você não
                deveria perder tempo lutando com pastas pesadas, xerox perdidos
                e áudios espalhados no WhatsApp.
              </p>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-3xl font-bold text-white mb-6 font-serif italic">
                  Regentify: Sua Batuta Digital
                </h3>
                <p className="text-slate-400 mb-8 leading-relaxed text-lg">
                  O Regentify foi criado para que você foque no que realmente
                  importa: **a música**. Transformamos seu tablet ou celular na
                  ferramenta de regência mais poderosa do mercado.
                </p>
      ...
      <section id="funcionalidades" className="py-24 bg-black/40">
        <div className="max-w-7xl mx-auto px-6">
          <SectionTitle subtitle="Funcionalidades">
            O que faz o Regentify ser indispensável?
          </SectionTitle>
          ...
          <div className="grid md:grid-cols-6 md:grid-rows-2 gap-4">
            ...
            <div className="md:col-span-3 md:row-span-2 glass rounded-[2.5rem] p-10 flex flex-col justify-between group hover:border-purple-500/40 transition-all">
              <div>
                ...
                <p className="text-slate-400 text-lg leading-relaxed">
                  Centralize todo o seu repertório em um só lugar. Tenha acesso
                  instantâneo a letras, áudios e anotações técnicas sem carregar
                  peso.
                </p>
              </div>
              <div className="mt-12 flex gap-2">
                {[1, 2, 3, 4].map((v) => (
                  <div
                    key={v}
                    className="w-10 h-10 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center font-bold text-purple-400"
                  >
            ...
            <div className="md:col-span-3 glass rounded-[2.5rem] p-8 flex items-center gap-8 group hover:border-blue-500/40 transition-all">
              ...
              <div>
                ...
                <p className="text-slate-400 text-sm">
                  Encontre letras automaticamente em bancos de dados globais
                  como Vagalume, Letras.mus e LRCLIB.
                </p>
              </div>
            </div>
            ...
            <div className="md:col-span-3 glass rounded-[2.5rem] p-8 flex items-center gap-8 group hover:border-pink-500/40 transition-all">
              ...
              <div>
                ...
                <p className="text-slate-400 text-sm">
                  Metrônomo e Diapasão para auxiliar nos seus ensaios.
                </p>
              </div>
            </div>
            ...
            <div className="md:col-span-2 glass rounded-[2.5rem] p-8 flex flex-col justify-between group hover:border-green-500/40 transition-all">
              ...
              <div>
                ...
                <p className="text-slate-400 text-xs">
                  Auto-scroll inteligente para você reger sem tocar na tela.
                </p>
              </div>
            </div>
            ...
            <div className="md:col-span-2 glass rounded-[2.5rem] p-8 flex flex-col justify-between group hover:border-orange-500/40 transition-all">
              ...
              <div>
                ...
                <p className="text-slate-400 text-xs">
                  Exporte letras formatadas com um clique.
                </p>
              </div>
            </div>
            ...
            <div className="md:col-span-2 glass rounded-[2.5rem] p-8 flex flex-col justify-between group hover:border-blue-400/40 transition-all">
              ...
              <div>
                ...
                <p className="text-slate-400 text-xs">
                  Monte o repertório do culto ou concerto em segundos.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-6">
          <SectionTitle subtitle="Passo a Passo">
            Como o Regentify transforma seu ensaio?
          </SectionTitle>
              ...
              >
                <div className="relative mb-8 overflow-hidden rounded-[2rem] border border-white/5">
                  <img
                    ...
                    referrerPolicy="no-referrer"
                  />
                  <div className="absolute top-4 left-4 w-12 h-12 bg-purple-600 rounded-xl flex items-center justify-center font-bold text-xl shadow-lg">
                    {item.step}
                  </div>
                </div>
      ...
      <section id="preço" className="py-24 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          <SectionTitle subtitle="Investimento">
            Sua música merece o melhor
          </SectionTitle>
          ...
          <div className="glass rounded-[3.5rem] border-2 border-purple-500/20 p-8 md:p-16 shadow-2xl relative overflow-hidden">
            ...
            <div className="mb-12">
              <p className="text-slate-400 mb-4 text-lg">
                Softwares de partitura custam mais de{" "}
                <span className="line-through">R$ 500/ano</span>. <br />
              ...
              >
                ...
                >
                  <Button
                    pulse={true}
                    className="w-full md:w-auto text-xl py-6 border-2 border-yellow-400/80 ring-2 ring-yellow-300/40"
                    variant="secondary"
                  >
      ...
      <footer className="py-20 border-t border-white/5 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid md:grid-cols-4 gap-12 mb-16">
            <div className="md:col-span-2">
              ...
              <p className="text-slate-400 max-w-sm leading-relaxed">
                Elevando o nível da música coral através da tecnologia. O
                assistente definitivo para quem rege com paixão e excelência.
              </p>
            </div>
            <div>
          ...
          <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-slate-600">
            <p>
              © 2024 Regentify - Assistente Coral. Todos os direitos reservados.
            </p>
